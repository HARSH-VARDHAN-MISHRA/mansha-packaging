var elements = document.querySelectorAll('.section-heading.light-head h2');
// Loop through each element and add the attribute
elements.forEach(function(element) {
    element.setAttribute('data-aos', 'fade-left');
    element.setAttribute('data-aos-offset', '150');
    element.setAttribute('data-aos-duration', '10000');
});

var elements1 = document.querySelectorAll('.section-heading.light-head p');
// Loop through each element and add the attribute
elements1.forEach(function(element) {
    element.setAttribute('data-aos', 'fade-left');
    element.setAttribute('data-aos-offset', '150');
    element.setAttribute('data-aos-duration', '15~000');
});
